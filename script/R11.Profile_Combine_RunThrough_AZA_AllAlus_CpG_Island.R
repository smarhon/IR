...
fileAZA=paste(inpDir,"/Profile_RunThrough_Regions_AZA_Alu_IR_CpG_Island.txt",sep="")
...
dataAZA=as.matrix(map)
	...
	pngFile=paste(outDir,"/Profile_RunThrough_Regions_AZA_AllAlus_Alu_IR_CpG_Island.png",sep="")
	...
	axis(1,at=c(0,50,100), labels=FALSE)
   	...
   	#axis(1,at=bk, cex.axis=1.1,labels=c("-50Kb","0","+50Kb"))
        #axis(2,cex.axis=1.1)
	legend(22,ymax, c("All IR-Alus (n=746,470)","AZA Specific IR-Alus (n=3,687)"), lwd=c(3,3), col=c("blue","red"),lty=c(1,1), cex=1.2,text.font=2)
