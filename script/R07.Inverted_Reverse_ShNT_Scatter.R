...
#library(mining)
cov="2.5"
map = read.table(paste(inpDir,"/Scatter_Inverted_Repeats_Reverse_ShNT_ratio.txt",sep=""),header=T)
...
xlabels=c("log10(LacZ_NT_2/LacZ_NT_0)","log10(LacZ_AZA_2/LacZ_AZA_0)","log10(Sh1_NT_2/Sh1_NT_0)","log10(Sh1_AZA_2/Sh1_AZA_0)")
...
id=Ids[i]
png(paste(outDir,"/Inverted_Repeats_Reverse_ShNT_Scatter-",id,".png",sep=""),width=1500,height=1500,bg="white",res=200)
