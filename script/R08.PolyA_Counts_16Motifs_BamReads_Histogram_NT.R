...
map = read.table(paste(inpDir,"/PolyA_Counts_16Motifs_BamReads_NT_AllMotifs_histogram.txt",sep=""),row.name=1,header=T)
...
png(paste(outDir,"/PolyA_Counts_16Motifs_BamReads_NT_AllMotifs_histogram.png",sep=""),width=1200,height=2400,bg="white",res=200)
