...
fileAZA=paste(inpDir,"/Profile_Upstream_Downstream_IRregion_Regions_AZA_Alu_IR_CpG.txt",sep="")
...
dataAZA<-c(dataAZA[1:1000],dataAZA[1201:2200])
	...
	pngFile=paste(outDir,"/Profile_Upstream_Downstream_Regions_AllAlus_AZA_Alu_IR_CpG.png",sep="")
	...
	text(y =c(0.0,0.005,0.01,0.015,0.02,0.025),-200,labels = c("0.000","0.005","0.010","0.015","0.020","0.025"), ,srt = 90,adj=0.5, xpd = TRUE,cex=1.3,font=2)
        ...
        #axis(1,at=bk, cex.axis=1.1,labels=c("-50Kb","0","+50Kb"))
        #axis(2,cex.axis=1.1)
        legend(600,ymax, c("All IR-Alus (n=746,470)","AZA Specific IR-Alus (n=3,687)"), lwd=c(3,3), col=c("blue","red"),lty=c(1,1), cex=1.2,text.font=2)
